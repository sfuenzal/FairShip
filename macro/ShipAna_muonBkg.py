...
ut.bookHist(h,'Digi_SBTHits_YvsX', 'Y vs X digitalized SBT Hits; x [cm]; y [cm]; Events', 400, -400., 400., 400, -400., 400.)
ut.bookHist(h,'Digi_SBTHits_Z', 'Z digitalized SBT Hits; z [cm]; Events', 400, -3000., 3000.)

ut.bookHist(h,'digiSBT2MC', 'Digi SBT to MC', 400, 0., 4000.)

ut.bookHist(h,'UpstreamTaggerPoint_trackID', 'Upstream tagger point trackID; track ID; Events', 400, 0, 400)
ut.bookHist(h,'UpstreamTaggerPoint_fY_versus_fX', 'Upstream tagger point Y versus X; x [cm]; y [cm]; Events', 400, -1000, 1000, 400, -1000, 1000)
ut.bookHist(h,'UpstreamTaggerPoint_fZ', 'Upstream tagger point Z; z [cm]; Events', 400, -1000, 1000)
ut.bookHist(h,'UpstreamTaggerPoint_fPy_versus_fPx', 'Upstream tagger point Py versus Px; p_{x} [GeV]; p_{y} [GeV]; Events', 400, -20, 20, 400, -20, 20)
ut.bookHist(h,'UpstreamTaggerPoint_fPz', 'Upstream tagger point Pz; p_{z} [GeV]; Events', 400, 0, 400)
ut.bookHist(h,'UpstreamTaggerPoint_fPt', 'Upstream tagger point Pt; p_{T} [GeV]; Events', 400, 0, 100)
ut.bookHist(h,'UpstreamTaggerPoint_fTime', 'Upstream tagger point time; t [ns]; Events', 400, 0, 1000)
ut.bookHist(h,'UpstreamTaggerPoint_fEloss', 'Upstream tagger point energy loss; E_{loss} [GeV]; Events', 400, 0, 10)
ut.bookHist(h,'UpstreamTaggerPoint_fPdgCode', 'Upstream tagger point PDG code; PDG code; Events', 400, 0, 20)

ut.bookHist(h,'vetoPoint_trackID', 'Veto point trackID; track ID; Events', 400, 0, 400)
ut.bookHist(h,'vetoPoint_fY_versus_fX', 'Veto point Y versus X; x [cm]; y [cm]; Events', 400, -1000, 1000, 400, -1000, 1000)
ut.bookHist(h,'vetoPoint_fZ', 'Veto point Z; z [cm]; Events', 400, -3000, 3000)
ut.bookHist(h,'vetoPoint_fPy_versus_fPx', 'Veto point Py versus Px; p_{x} [GeV]; Events', 400, -0.3, 0.3, 400, -0.3, 0.3)
ut.bookHist(h,'vetoPoint_fPz', 'Veto point Pz; p_{z} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'vetoPoint_fPt', 'Veto point Pt; p_{T} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'vetoPoint_fTime', 'Veto point time; t [ns]; Events', 400, 0, 1000)
ut.bookHist(h,'vetoPoint_fEloss', 'Veto point energy loss; E_{loss} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'vetoPoint_fPdgCode', 'Veto point PDG code; PDG code; Events', 400, 0, 20)

ut.bookHist(h,'strawtubesPoint_trackID', 'Strawtubes point trackID; track ID; Events', 400, 0, 400)
ut.bookHist(h,'strawtubesPoint_fY_versus_fX', 'Strawtubes point Y versus X; x [cm]; y [cm]; Events', 400, 0, 1000, 400, 0, 1000)
ut.bookHist(h,'strawtubesPoint_fZ', 'Strawtubes point Z; z [cm]; Events', 400, 0, 3000)
ut.bookHist(h,'strawtubesPoint_fPy_versus_fPx', 'Strawtubes point Py versus Px; p_{x} [GeV]; p_{y} [GeV]; Events', 400, -0.06, 0.06, 400, -0.06, 0.06)
ut.bookHist(h,'strawtubesPoint_fPz', 'Strawtubes point Pz; p_{z} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'strawtubesPoint_fPt', 'Strawtubes point Pt; p_{T} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'strawtubesPoint_fTime', 'Strawtubes point time; t [ns]; Events', 400, 0, 1000)
ut.bookHist(h,'strawtubesPoint_fEloss', 'Strawtubes point energy loss; E_{loss}; Events', 400, 0, 0.001)
ut.bookHist(h,'strawtubesPoint_fPdgCode', 'Strawtubes point PDG code; PDG code; Events', 400, 0, 20)

ut.bookHist(h,'MCTrack_MotherId', 'MC tracks mother ID; Mother ID; Events', 400, 0, 400)
ut.bookHist(h,'MCTrack_fStartY_versus_fStartX', 'MC tracks start Y versus start X; x [cm]; y [cm]; Events', 400, -1000, 1000, 400, -1000, 1000)
ut.bookHist(h,'MCTrack_fStartZ', 'MC tracks start Z; z [cm]; Events', 400, -3000, 3000)
ut.bookHist(h,'MCTrack_fPy_versus_fPx', 'MC tracks Py versus Px; p_{x} [GeV]; p_{y} [GeV]; Events', 400, -20, 20, 400, -20, 20)
ut.bookHist(h,'MCTrack_fPz', 'MC tracks Pz; p_{z} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'MCTrack_fPt', 'MC tracks Pt; p_{T} [GeV]; Events', 400, 0, 0.01)
ut.bookHist(h,'MCTrack_fM', 'MC tracks M; M [GeV]; Events', 400, 0, 20)
ut.bookHist(h,'MCTrack_fPdgCode', 'MC tracks PDG code; PDG code; Events', 400, 0, 20)
