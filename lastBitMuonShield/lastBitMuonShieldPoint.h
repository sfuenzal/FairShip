...
class lastBitMuonShieldPoint : public FairMCPoint
{

  public:

    /** Default constructor **/
    lastBitMuonShieldPoint();
     ...
     **/
    lastBitMuonShieldPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom,
                     Double_t tof, Double_t length, Double_t eLoss, Int_t pdgCode, TVector3 Lpos, TVector3 Lmom);

    /** Destructor **/
    virtual ~lastBitMuonShieldPoint();
  ...
  private:
    ...
    lastBitMuonShieldPoint(const lastBitMuonShieldPoint& point);
    lastBitMuonShieldPoint operator=(const lastBitMuonShieldPoint& point);

    ClassDef(lastBitMuonShieldPoint,1)
